...
ENV NODE_ENV=production \
 ...
 DM_ORGANIZATION_SCHEMA= \
 DM_ENTERPRISE_DOMAIN_NAME_ATTRIBUTE="associatedDomain" \
 DM_ENTERPRISE_DOMAIN_LINK_ATTRIBUTE= \
 DM_STORAGE_BACKEND= \
 DM_STORAGE_SWEEP_INTERVAL="600" \
 DM_STORAGE_LDAP_BASE= \
 DM_STORAGE_LDAP_OBJECT_CLASS="applicationProcess" \
 DM_STORAGE_FILE_DIRECTORY= \
 DM_BCL_RETENTION="604800" \
 DM_LDAP_GROUP_BASE= \
 ...
 DM_LDAP_RAW_SHOW_SECRETS=false \
 DM_LDAP_RAW_MAX_RESULTS="200" \
 DM_LDAP_RAW_SCHEMA_CACHE_TTL="3600" \
 ...
 DM_CALENDAR_FIRSTNAME_ATTRIBUTE="givenName" \
 DM_CALENDAR_LASTNAME_ATTRIBUTE="sn" \
 DM_COZY_ADMIN_URL= \
 DM_COZY_ADMIN_USER="admin" \
 DM_COZY_ADMIN_PASSPHRASE= \
 DM_COZY_ORG_ID= \
 DM_COZY_ORG_DOMAIN= \
 DM_COZY_DEFAULT_LOCALE="fr" \
 DM_COZY_CONTEXT_NAME="default" \
 DM_COZY_APPS="home,drive,settings,notes,dataproxy" \
 DM_COZY_AUTH_EXCHANGE="auth" \
 DM_COZY_B2B_EXCHANGE="b2b" \
 DM_COZY_USER_CREATED_ROUTING_KEY="user.created" \
 DM_COZY_USER_DELETED_ROUTING_KEY="domain.user.deleted" \
 DM_CLOUDERY_MANAGER_URL= \
 DM_CLOUDERY_MANAGER_TOKEN= \
 DM_CLOUDERY_OFFER="b2b_twake_default" \
 DM_CLOUDERY_DOMAIN= \
 DM_CLOUDERY_USER_BRANCH= \
 DM_CLOUDERY_ORG_ID_HEADER="x-cloudery-org-id" \
 DM_CLOUDERY_ORG_ROLE_HEADER="x-cloudery-org-role" \
 DM_CLOUDERY_DEFAULT_ORG_ROLE="member" \
 DM_CLOUDERY_FQDN_ATTRIBUTE="twakeWorkspaceUrl" \
 DM_CLOUDERY_ORG_ID_ATTRIBUTE="twakeOrganizationId" \
 DM_CLOUDERY_ORG_ROLE_ATTRIBUTE="twakeOrganizationRole" \
 DM_CLOUDERY_PHONES_ATTRIBUTE="twakePhones" \
 DM_CLOUDERY_INVITED_ATTRIBUTE="twakeInvited" \
 DM_CLOUDERY_DEFAULT_LOCALE="en" \
 DM_CLOUDERY_WORKFLOW_POLL_INTERVAL_MS="2000" \
 DM_CLOUDERY_WORKFLOW_MAX_ATTEMPTS="60" \
 DM_TWAKE_LIFECYCLE_ROLE_ATTRIBUTE= \
 DM_TWAKE_LIFECYCLE_LOCK_ATTRIBUTE= \
 DM_TWAKE_LIFECYCLE_DELETED_ATTRIBUTE= \
 DM_TWAKE_LIFECYCLE_DELETED_VALUE="TRUE" \
 DM_TWAKE_LIFECYCLE_DELETED_AT_ATTRIBUTE= \
 DM_TWAKE_LIFECYCLE_DELETED_AT_FORMAT="iso8601" \
 DM_TWAKE_LIFECYCLE_LOCK_VALUE= \
 DM_TWAKE_LIFECYCLE_REASON_ATTRIBUTE= \
 DM_TWAKE_LIFECYCLE_RULES= \
 DM_TWAKE_TOMBSTONE_DN= \
 DM_TWAKE_TOMBSTONE_DEFAULT_REASON="deleted" \
 DM_TWAKE_TOMBSTONE_REASON_HEADER="x-deletion-reason" \
 DM_TWAKE_TOMBSTONE_REASONS= \
 DM_TWAKE_TOMBSTONE_CLEAR_ATTRIBUTES= \
 DM_TWAKE_TOMBSTONE_ERASE_MIN_AGE="2592000" \
 ...
 DM_AUTHZ_DYNAMIC_CACHE_TTL="60" \
 DM_AUTHZ_DYNAMIC_TOKEN_ATTRIBUTE="userPassword" \
 DM_AUTHZ_DYNAMIC_CONFIG_ATTRIBUTE="description" \
 DM_AUTHZ_DYNAMIC_TENANT_ATTRIBUTE="cn" \
 DM_AUTHZ_DYNAMIC_RELOAD_ENDPOINT=false \
 DM_AUTHZ_LOCAL_ADMIN_ATTRIBUTE="twakeLocalAdminLink" \
 DM_OIDC_SERVER= \
 DM_OIDC_USERNAME_CLAIM="sub" \
 DM_OIDC_CLIENT_ID= \
 ...
 DM_LDAP_USERS_BASE= \
 DM_SCIM_PREFIX="/scim/v2" \
 DM_SCIM_USER_BASE= \
 DM_SCIM_GROUP_BASE= \
 DM_SCIM_USER_BASE_TEMPLATE= \
 DM_SCIM_GROUP_BASE_TEMPLATE= \
 DM_SCIM_BASE_MAP= \
 DM_SCIM_USER_BASE_HEADER= \
 DM_SCIM_GROUP_BASE_HEADER= \
 DM_SCIM_BASE_HEADER_ROOT= \
 DM_SCIM_USER_OBJECT_CLASSES=top,inetOrgPerson,organizationalPerson,person \
 DM_SCIM_USER_RDN_ATTRIBUTE="uid" \
 DM_SCIM_USER_LOCK_ATTRIBUTE="pwdAccountLockedTime" \
 DM_SCIM_USER_LOCK_VALUE= \
 DM_SCIM_GROUP_OBJECT_CLASSES=top,groupOfNames \
 DM_SCIM_GROUP_RDN_ATTRIBUTE="cn" \
 DM_SCIM_GROUP_EXTERNAL_ID_ATTRIBUTE= \
 DM_SCIM_ID_ATTRIBUTE="rdn" \
 DM_SCIM_USER_MAPPING= \
 DM_SCIM_GROUP_MAPPING= \
 DM_SCIM_MAX_RESULTS="200" \
 DM_SCIM_MAX_SCANNED="10000" \
 DM_SCIM_BULK_MAX_OPERATIONS="100" \
 DM_SCIM_BULK_MAX_PAYLOAD_SIZE="1048576" \
 DM_SCIM_ETAG=false \
 DM_SCIM_BASE_URL=
